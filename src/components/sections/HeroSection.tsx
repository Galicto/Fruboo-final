    ...
    <>
      ...
      >
        <motion.h1 
          ...
          className="text-[26vw] leading-[0.8] font-black tracking-tighter select-none text-[#3a3a3a] drop-shadow-2xl"
        >
          FRUBOO
        </motion.h1>
      </motion.div>
      ...
      >
        <motion.p
          ...
          className="text-lg md:text-3xl text-white tracking-[0.4em] uppercase font-bold drop-shadow-[0_2px_15px_rgba(0,0,0,0.8)]"
        >
          sip <span className="mx-4 md:mx-6 text-[var(--color-accent-orange)] mix-blend-screen drop-shadow-md">|</span> 
          eat <span className="mx-4 md:mx-6 text-[var(--color-accent-green)] mix-blend-screen drop-shadow-md">|</span> 
          feel
        </motion.p>
        ...
        <motion.p
          ...
          className="mt-6 md:mt-8 text-xs md:text-sm text-white/90 tracking-[0.2em] uppercase font-bold max-w-sm drop-shadow-md"
        >
