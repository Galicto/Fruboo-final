...
export function Experience({ scrollYProgress }: { scrollYProgress: MotionValue<number> }) {
  ...
  return (
    ...
    >
      <div className="text-center bg-black/60 backdrop-blur-2xl p-8 md:p-16 rounded-[2rem] md:rounded-[2.5rem] border border-white/10 shadow-[0_20px_60px_rgba(0,0,0,0.8)] max-w-3xl w-full">
        <h2 className="text-4xl md:text-8xl font-bold text-white tracking-tight mb-6 md:mb-8 drop-shadow-lg">
          Not just a drink.
        </h2>
        <p className="text-2xl md:text-5xl text-[var(--color-accent-aqua)] font-medium mb-4 md:mb-6 drop-shadow-[0_0_15px_rgba(174,239,239,0.3)] tracking-tight">
